...
const ForgotPasswordComponent = ({ handleClose, handleLoginClick }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto">
            ...
            <div className="flex min-h-full items-center justify-center p-4">
                <div className="relative bg-white w-full max-w-lg rounded-2xl shadow-2xl transform transition-all">
                    <button
                        onClick={handleClose}
                    ...
                    <div className="p-8">
                        <form onSubmit={handleSubmit}>
                            <div className="text-center mb-6">
                                <h1 className="text-3xl font-bold text-gray-900 mb-4">Quên mật khẩu?</h1>
                                <p className="text-gray-600">Nhập email của bạn để nhận được hướng dẫn khôi phục mật khẩu</p>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="relative">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type="email"
                                            placeholder="Email tài khoản khôi phục"
                                            value={email}
